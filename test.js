...
console.log('- CC accounting@innovationbound.com\n')

// Run invoice test (safest - doesn't charge)
handler(invoiceRequest)
  .then(result => {
    ...
    console.log('   - student#2026-ai-accelerator / costa@trollhair.com')
    console.log('2. Check email inbox at costa@trollhair.com')
    console.log('3. Check accounting@innovationbound.com for CC')
    console.log('4. Clean up DynamoDB records when done testing')
  })
  .catch(error => {
    console.error('\n❌ ERROR!\n')
    console.error(error)
